...
var updateAccountService = function (account) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        if (acc.length === accounts.length && account.level === 'Level 3') {
            ...
            acc.map(function (e, index) {
                if (e.id === account.parentId) {
                    //e.parentId = 1; //account.id;
                    var temp = e;
                    // acc[index - 1].parentId = 1;
                    return __assign(__assign({}, e), { 'parentId': account.id });
                }
                return e;
            });
        }
...
//# sourceMappingURL=bundle~._src_se.ac0a72ff6d24af358de7.hot-update.js.map