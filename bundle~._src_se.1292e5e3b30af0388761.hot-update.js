...
var accounts = [
    ...
    },
    {
        ...
        partnerLabelId: 'Conan Huynh', statusAccount: 'pending1', license: 'Curacao', credit: 'Yes', creditLimit: 'N/A',
...
var updateAccountService = function (account) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        if (acc.length === accounts.length && account.level === 'Level 3') {
            acc = acc.map(function (e) {
                if (e.id === account.parentId) {
                    e = __assign(__assign({}, e), { 'parentId': account.id });
                }
                return e;
            });
        }
...
//# sourceMappingURL=bundle~._src_se.1292e5e3b30af0388761.hot-update.js.map