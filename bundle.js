...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "f6370ab73c8537b6d39e";
...
/******/ 	__webpack_require__.p = "/corporate-account-ui/";
/******/
...
/******/ 	deferredModules.push([0,"bundle~._m","bundle~._node_modules_a","bundle~._node_modules_e","bundle~._node_modules_r","bundle~._node_modules_react-d","bundle~._node_modules_react-dom_cjs_react-dom.development.js~61bb2bf2","bundle~._node_modules_react-r","bundle~._node_modules_react_cjs_react.development.js~72d06b57","bundle~._node_modules_s","bundle~._node_modules_u","bundle~._src_a","bundle~._src_app_app.scss~14bfd9d5"]);
...
/***/ "./src/store/middleware/root.saga.ts":
/*!*******************************************!*\
  !*** ./src/store/middleware/root.saga.ts ***!
  \*******************************************/
...
/* harmony import */ var redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! redux-saga/effects */ "./node_modules/redux-saga/dist/redux-saga-effects-npm-proxy.esm.js");
/* harmony import */ var _account_saga__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./account.saga */ "./src/store/middleware/account.saga.tsx");
var __generator = (undefined && undefined.__generator) || function (thisArg, body) {
    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;
    return g = { next: verb(0), "throw": verb(1), "return": verb(2) }, typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; }), g;
    function verb(n) { return function (v) { return step([n, v]); }; }
...
function RootSaga() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["all"])([
                    Object(_account_saga__WEBPACK_IMPORTED_MODULE_1__["AccountSaga"])()
                ])];
            case 1:
                _a.sent();
                return [2 /*return*/];
...
/***/ "./src/store/slice/account.slice.ts":
/*!******************************************!*\
  !*** ./src/store/slice/account.slice.ts ***!
  \******************************************/
/*! exports provided: AccountSlice, loadAccounts, loadAccountsSuccess, loadAccountsError, onToggleNavbar, getAccountDetail, getAccountDetailError, getAccountDetailSuccess, saveAccount, saveAccountSuccess, saveAccountError, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AccountSlice", function() { return AccountSlice; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "loadAccountsError", function() { return loadAccountsError; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onToggleNavbar", function() { return onToggleNavbar; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getAccountDetail", function() { return getAccountDetail; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getAccountDetailError", function() { return getAccountDetailError; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getAccountDetailSuccess", function() { return getAccountDetailSuccess; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "saveAccount", function() { return saveAccount; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "saveAccountSuccess", function() { return saveAccountSuccess; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "saveAccountError", function() { return saveAccountError; });
...
var AccountSlice = Object(_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__["createSlice"])({
    name: 'Account',
    initialState: initialState,
    reducers: {
        loadAccounts: function (state, payloadAction) {
            state.loading = true;
            state.error = '';
        ...
        loadAccountsSuccess: function (state, payloadAction) {
            var _a;
            state.loading = false;
            state.error = '';
            state.accounts = payloadAction.payload;
            if ((_a = payloadAction.payload) === null || _a === void 0 ? void 0 : _a.length) {
                state.isShowAccountListing = true;
            }
        },
        loadAccountsError: function (state) {
            state.error = 'failed';
            state.loading = true;
            react_toastify__WEBPACK_IMPORTED_MODULE_1__["toast"].error('get accounts failed. Please contact admin!');
        },
        onToggleNavbar: function (state, payloadAction) {
            state.toggleNavbar = payloadAction.payload;
        },
        getAccountDetail: function (state, payloadAction) {
            state.loading = true;
            state.error = '';
        ...
        getAccountDetailSuccess: function (state, payloadAction) {
            state.loading = false;
            state.error = '';
            state.accountDetail = payloadAction.payload;
        },
        getAccountDetailError: function (state) {
            state.loading = false;
            state.error = 'failed';
            react_toastify__WEBPACK_IMPORTED_MODULE_1__["toast"].error('get account detail failed. Please contact admin!');
        },
        saveAccount: function (state, payloadAction) {
            state.loading = true;
            state.error = '';
            state.isUpdateAccount = false;
        },
        saveAccountSuccess: function (state, payloadAction) {
            state.loading = false;
            state.error = '';
            state.isUpdateAccount = true;
            react_toastify__WEBPACK_IMPORTED_MODULE_1__["toast"].success('Update Account successfully!');
        },
        saveAccountError: function (state) {
            state.loading = false;
            state.error = 'failed';
            react_toastify__WEBPACK_IMPORTED_MODULE_1__["toast"].error('Update account failed. Please contact admin!');
        },
    }
});
var loadAccounts = (_a = AccountSlice.actions, _a.loadAccounts), loadAccountsSuccess = _a.loadAccountsSuccess, loadAccountsError = _a.loadAccountsError, onToggleNavbar = _a.onToggleNavbar, getAccountDetail = _a.getAccountDetail, getAccountDetailError = _a.getAccountDetailError, getAccountDetailSuccess = _a.getAccountDetailSuccess, saveAccount = _a.saveAccount, saveAccountSuccess = _a.saveAccountSuccess, saveAccountError = _a.saveAccountError;
/* harmony default export */ __webpack_exports__["default"] = (AccountSlice.reducer);


/***/ }),

/***/ "./src/store/slice/root.reducer.ts":
/*!*****************************************!*\
  !*** ./src/store/slice/root.reducer.ts ***!
  \*****************************************/
...
/* harmony import */ var _slice_account_slice__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../slice/account.slice */ "./src/store/slice/account.slice.ts");


var RootReducer = Object(redux__WEBPACK_IMPORTED_MODULE_0__["combineReducers"])({
    account: _slice_account_slice__WEBPACK_IMPORTED_MODULE_1__["default"],
});
...
/* harmony import */ var _slice_root_reducer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./slice/root.reducer */ "./src/store/slice/root.reducer.ts");
/* harmony import */ var _middleware_root_saga__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./middleware/root.saga */ "./src/store/middleware/root.saga.ts");
...
var Store = Object(_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1__["configureStore"])({
    reducer: _slice_root_reducer__WEBPACK_IMPORTED_MODULE_2__["RootReducer"],
    middleware: [sagaMiddleware]
});
sagaMiddleware.run(_middleware_root_saga__WEBPACK_IMPORTED_MODULE_3__["RootSaga"]);
