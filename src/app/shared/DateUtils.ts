...
//     SLASH_UMM_UDD_UYYYY,
//     DEFAULT_TIME_ZONE
// } from '../../common/constants/DateFormatConst';
...
//     const formatDate = !!format ? format : HYPHEN_UYYYY_UMM_UDD_UHH_MM_SS;
...
//     const formatDate = !!format ? format : HYPHEN_UYYYY_UMM_UDD;
...
//     return getMoment(getNow()).valueOf();
// };
...
//     return getMoment(getNow()).subtract(1, 'week')
// }
