    ...
    return __generator(this, function (_a) {
        ...
        if (acc.length === accounts.length && account.level === 'Level 3') {
            if (account.parentId) { // chac chan phai co
                acc.push(account);
                accountLevel2 = accounts.find(function (e) { return e.id === account.parentId; });
                accountLevel2.partnerId = account.parentId;
...
//# sourceMappingURL=bundle~._src_se.aefc5609db5981c71c42.hot-update.js.map